package com.example.picassoandroidlibrary;
...
public class MovieAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Picasso.with(mContext)
                ...
                .placeholder
                        (R.drawable.ic_launcher_background) //Image resource that act as placeholder
        ...
        imageViewFavorite.setImageResource(
                movie.getIsFavorite() ? R.drawable.ic_launcher_foreground : R.drawable.ic_launcher_background);
        return convertView;
    }
}
